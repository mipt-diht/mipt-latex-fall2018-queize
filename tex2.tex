...
\newenvironment{tasks}[1]{\stepcounter{Number} \underline{\textbf{Задача №\arabic{Number}. #1 }}  \\[8pt]}{\noindent \\}
...
Случайный вектор $\vec{\xi}$~--- гауссовский, если $\forall \lambda \in \mathbb{R}^n$ случайный вектор $(\vec{\lambda}, \vec{\xi})$ имеет нормальное распределение
	...
	\begin{itemize}
		...
		\item \textbf{Хотелось бы побольше примеров. Теория всегда хорошо, но практика приоритетнее}
		\item \textbf{Самый лучший лектор - это твой сверстник: с ним всегда можно найти общий язык}
	\end{itemize}
\end{document}
